...
import retoon.retoon_server.src.user.auth.token.NaverToken;
...
public class OAuthNaver implements OAuthSocial {
    ...
    public String extractAccessToken(String code) throws JsonProcessingException {
        ...
        if(responseEntity.getStatusCode() == HttpStatus.OK){
            //JSON 객체 반환
            naverToken = mapper.readValue(responseEntity.getBody(), NaverToken.class);
    ...
    public SocialProfileDto getUserProfileInfo(String accessToken){
        ...
        //사용자 정보 추출
        System.out.println(">> naver user information :: {}" + socialProfileDto);
